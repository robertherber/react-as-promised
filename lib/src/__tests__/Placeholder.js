...
describe.only('Manager', () => {
  ...
  it('Should show component', () => {
    ...
    expect(content.type).toEqual('p');
    expect(content.props.resolve).toEqual(expect.any(Function));
    expect(content.props.reject).toEqual(expect.any(Function));
    expect(content.props.onCancel).toEqual(expect.any(Function));
  });
  ...
  it('Should show component with custom resolver/rejecter', () => {
    ...
    const content = renderer.toJSON();
    expect(content.type).toEqual('p');
    expect(content.props.onResolved).toEqual(expect.any(Function));
    expect(content.props.onRejected).toEqual(expect.any(Function));
    expect(content.props.onCancel).toEqual(expect.any(Function));
  });
  ...
  it('Should remove component when cancelling', () => {
    ...
    const newContent = renderer.toJSON();
